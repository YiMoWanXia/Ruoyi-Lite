package com.ruoyi.lite.core.module.system.service;
...
public interface ISysFileService {
     ...
     * @return 文件集合
     */
    List<SysFile> selectFilesByBusiness(String businessType, Long businessId);
     ...
     * @return RAG文档集合
     */
    List<SysFile> selectRagDocuments(Long knowledgeBaseId);
     ...
     * @return 文件
     */
    SysFile selectFileByContentHash(String contentHash);
     ...
     * @return 文件数量
     */
    int countFilesByBusinessType(String businessType);
     ...
     * @return 文件总大小
     */
    Long sumFileSizeByBusinessType(String businessType);
     ...
     * @return 结果
     */
    int updateFileStatus(Long id, Integer status);
     ...
     * @return 结果
     */
    int updateProcessProgress(Long id, Integer progress, String errorMessage);
     ...
     * @return 结果
     */
    int cleanDeletedFiles(Integer days);
     ...
     * @return 文件信息
     */
    SysFile uploadFile(MultipartFile file, String businessType, Long businessId, Long parentId);
     ...
     * @return 文件信息
     */
    SysFile uploadRagDocument(MultipartFile file, Long knowledgeBaseId);
     ...
     * @return 文件信息
     */
    SysFile uploadUserAvatar(MultipartFile file, Long userId);
     ...
     * @return 文件信息
     */
    SysFile uploadSystemAttachment(MultipartFile file, Long relatedId);
     ...
     * @return 是否存在
     */
    boolean isFileExists(String contentHash);
    ...
    Page<SysFile> selectSysFilePageList(SysFile sysFile);
}
