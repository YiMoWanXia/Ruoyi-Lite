...
import com.ruoyi.lite.core.base.framework.security.service.SysPermissionService;
...
import com.ruoyi.lite.core.module.system.domain.SysUserRole;
...
public class SysRoleController extends BaseController {
    ...
    public TableDataInfo list(SysRole role) {
        Page<SysRole> list = roleService.selectRolePageList(role);
    ...
    public TableDataInfo allocatedList(SysUser user) {
        Page<SysUser> list = userService.selectAllocatedPageList(user);
        return getDataTable(list);
    }
    ...
    public TableDataInfo unallocatedList(SysUser user) {
        Page<SysUser> list = userService.selectUnallocatedPageList(user);
        return getDataTable(list);
    }
    ...
    public AjaxResult selectAuthUserAll(@RequestParam Long roleId, @RequestParam(value = "userIds[]") Long[] userIds) {
        roleService.checkRoleDataScope(roleId);
