...
import com.ruoyi.lite.core.base.common.exception.user.*;
...
public class SysLoginService {
    ...
    public void loginPreCheck(String username, String password) {
        ...
        if (IpUtils.isMatchedIp(blackStr, IpUtils.getIpAddr())) {
            AsyncManager.me().execute(AsyncFactory.recordLoginLog(username, Constants.LOGIN_FAIL, MessageUtils.message("login.blocked")));
